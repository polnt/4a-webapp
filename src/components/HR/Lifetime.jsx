  ...
  return (
    <div className="container_page">
      <div className="content_page">
        ...
        <p>
          Il peut également y avoir une modification du contrat de travail, par
          le biais d’un avenant au contrat que nous réalisons pour vous, il est
          simple de faire évoluer votre personnel tout en assurant le respect
          des textes.
        </p>
        <h2>La sortie du salarié</h2>
        <p>
          L’un de vos salariés quitte l’entreprise, nous réalisons les documents
          de fin de contrat accompagnant le solde de tout compte en assurant le
