    ...
    <div className="container_page cover_page">
      <article className="content_page">
        ...
        <section>
          ...
          <p>
            Nous assurons la mise à jour de l’évolution législative de la paie,
            des procédures et la vérification de la justesse de vos bulletins.
          </p>
          <p>
            Vous gardez la main en vous assurant les compétences d’un
            professionnel spécialisé en paie.
          </p>
        </section>
        <section>
