...
const ExpertComptable = () => {
  return (
    <div style={{ gridColumnStart: 2 }}>
      ...
      <p>
        La gestion du social est de plus en plus complexe, la législation évolue
        très rapidement et il devient difficile de dédier le temps nécessaire
        aux actualisations et aux mises à jour. De plus, la crise sanitaire a
        mis à mal bien des services Paie et le recrutement aujourd’hui est de
      ...
      <p>
        ...
        recrutement, proposez une offre complète pour vos clients en établissant
        un partenariat avec 4A Paie et RH Conseils.
      </p>
      <p>
        Pôle social développé en souffrance : actuellement nous cherchons une
        solution viable, pour l’instant possible si vous avez Silae. Ou prendre
